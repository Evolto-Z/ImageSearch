...
# 来自https://blog.csdn.net/u010501845/article/details/124931326
...
class FontAction(QAction):
    ...
    def __init__(self, text, parent):
        super().__init__(text, parent)
        self.setIcon(QIcon(r"Resources/Images/font.png"))
...
class ScreenShotToolBar(QToolBar):
    ...
    def __init__(self, god):
        ...
        self._at_rectangle = QAction(QIcon(r"Resources/Images/rectangle.png"), '矩形', self, triggered=self.beforeDrawRectangle)
        self._at_ellipse = QAction(QIcon(r"Resources/Images/ellipse.png"), '椭圆', self, triggered=self.beforeDrawEllipse)
        self._at_graffiti = QAction(QIcon(r"Resources/Images/graffiti.png"), '涂鸦', self, triggered=self.beforeDrawGraffiti)
        self._at_textInput = QAction(QIcon(r"Resources/Images/write.png"), '文字', self, triggered=self.beforeDrawText)
        ...
        self.addAction(QAction(QIcon(r"Resources/Images/undo.png"), '撤销', self, triggered=self.undo))
        self.addSeparator()
        self.addAction(QAction(QIcon(r"Resources/Images/ensure.png"), '确定', self, triggered=self.god.onEnsure))
        self.addAction(QAction(QIcon(r"Resources/Images/cancel.png"), '退出', self, triggered=self.god.close))
        # self.addAction(QAction(QIcon(r"Resources/Images/download.png"), '保存', self, triggered=lambda: self.beforeSave('local')))
        # self.addAction(QAction(QIcon(r"Resources/Images/sendImg.png"), '复制', self, triggered=lambda: self.beforeSave('clipboard')))
...
class ScreenShotWidget(QWidget):
    ...
    def __init__(self, ensureCallback=lambda: None):
        super().__init__()
        ...
        # self.setPalette(palette)
        self.ensureCallback = ensureCallback
    ...
    def onEnsure(self):
        self.close()
        self.ensureCallback(self.screenArea.centerPhysicalPixmap().toImage())
